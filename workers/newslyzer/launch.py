...
if __name__ == '__main__':
    if len(sys.argv) == 1:
        ...
        url = 'http://0.0.0.0:1111/Pedro%20S%C3%A1nchez%20sube%20el%20tono%20contra%20Iglesias%20para%20redoblar%20la%20presi%C3%B3n%20a%20las%20puertas%20de%20la%20investidura.html'
